 ...
 * @author Benno Müller
 */
public class PreOrderTreeVisitorTest {
    ...
    private PreOrderTreeVisitor<Map<TreePath, Integer>> visitor;

    @Before
    public void setUp() throws Exception {
        visitor = new PreOrderTreeVisitor<Map<TreePath, Integer>>() {
    ...
    @Test
    public void visitsNodeBeforeChildren() throws Exception {
        ...
        assertThat(visitOrder.get(PARENT_NODE_PATH), is(1));
        assertThat(visitOrder.get(CHILD_NODE_PATH), is(2));
    }
