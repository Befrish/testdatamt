 ...
 * @author Benno Müller
 */
public class AscendingTreeVisitorTest {
    ...
    private AscendingTreeVisitor<Map<TreePath, Integer>> visitor;

    @Before
    public void setUp() throws Exception {
        visitor = new AscendingTreeVisitor<Map<TreePath, Integer>>() {
    ...
    @Test
    public void visitsNodeBeforeParent() throws Exception {
